  ...
  // 获取用户信息
    ...
    const downTime=()=>{
      let timer=setInterval(()=>{
        ...
        if(!downSecond) setDownSecond(60)
        else  setDownSecond(downSecond-1)
      },1000)
    }
  ...
  return (
    <View className='login'>
        ...
        <Input
          ...
          maxlength={6}
        />
        <Text className='getCode font-default-style' onClick={getCode}>{downSecond?downSecond+'后重试':'获取验证码'}</Text>
