...
export default function Index () {
  ...
  const concelRecord=()=>{
    ...
    let record=[
      {type:'功能阅读预约',time:'2021/01/18',name:'亲子预约',vip:'预约会员',phone:'18680704968',appointDay:'2022年08月23日 17:00-19:00 17:00-19:00 17:00-19:00 17:00-19:00'}
    ]
          ...
          record.map(item=>
            <View className='record-view font-default-style' key={item.time+item.type}>
              ...
              <View className='record-info'>
                ...
                <View style={{textAlign:'right'}}>{item.appointTime}</View>
              </View>
