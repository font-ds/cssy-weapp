...
import {alertHidden, longTimeShow,alertShow} from '../../../../store/alertModal';
            ...
            <View className='record-view' key={item.borrow_date}>
              ...
              <View className='btn-view'>
                <View>
                  ...
                  <Text >{item.state?item.state==1?'借阅中':'已完成':'待取书'}</Text> 
                </View>
                <AtButton className={item.state==2?'record-btn btn-finish':'record-btn'} type='primary' 
