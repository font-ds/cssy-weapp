...
export default function Index () {
  ...
  let vipPower=[
    {imageUrl:null,name:'精品阅读',discribe:'提供精品书籍'},
    {imageUrl:null,name:'丰富阅读',discribe:'专享互动阅读'},
    {imageUrl:null,name:'专享借阅',discribe:'专享书籍借阅'},
  ]
    ...
    return (
      <View className='power'>
        <View className='vip-view'>
          <View className='time'>
            <Text className='vip-type-top'>当前身份</Text>
            <Text>有效至:2022。09.15</Text>
          </View>
          <View className='vip-type'>
            S V I P
          </View>
          <AtButton className='btn' circle  type='primary' onClick={upVip}>续费/升级</AtButton>
        </View>
