      ...
      <View className='mime'>
        ...
        <View className='top-view'>
          ...
          <View className='vip-view'>
            <Text className='vip-type'>{info?.power==1?'VIP':info?.power==2?'SVIP':'普通'}会员<Text className='hr'></Text><Text className='vip-time font-default-style'>2022.09.15到期</Text></Text>
            <Text className='vip-btn' onClick={navitation('/pages/home/mine/power/index?info='+info)}>查看权益</Text>
          </View>
