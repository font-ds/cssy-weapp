...
export default function AppointDetail() {
  return (
    <View className='appointDetail'>
      ...
      <AtButton className='btn' style={{backgroundColor:true?'linear-gradient(270deg, #20C58D -16.56%, #64E9B0 115.94%)':'background: rgba(101, 124, 133, 0.6);'}} 
        type='primary'>确 认 预 约</AtButton>
    </View>
  )
}
