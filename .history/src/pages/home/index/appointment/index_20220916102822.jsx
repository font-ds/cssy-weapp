...
import {getImage} from '../../../../utils/cos-js-sdk'
import './index.scss'
...
export default function Index () {
  ...
  console.log('get',getImage('1.png'))
  ...
  const [swiperCurrent,setSwiperCurrent]=useState(0)
    ...
    return (
      <View className='appointment'>
        ...
        <View className={swiperCurrent==0?'img-view':swiperCurrent==1?'img-view choose-two':'img-view choose-three'}>
          <Image className='choose-bottom' src={require(getImage('1.png'))} />
        </View>
