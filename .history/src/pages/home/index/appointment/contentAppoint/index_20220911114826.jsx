...
export default function ContentAppoint() {
  ...
  return (
    <View className='contentAppoint'>
      ...
      <View style={{marginTop:'13px',fontSize:'28px',color: '#435A62'}}>内容介绍：</View>
      ...
      <AtButton className='btn'  type='primary' 
        onClick={()=>Taro.navigateTo({url:'/pages/home/index/components/appointDetail/index?data='+JSON.stringify(data)})}
      >
        确 认 预 约
      </AtButton>
