...
export default function Reading () {
  ...
  let topChoose=[
    ...
    {english:'日',chinese:'今天'},
    {english:'一',chinese:'今天'},
    {english:'二',chinese:'今天'},
    {english:'三',chinese:'今天'},
    {english:'四',chinese:'今天'},
    {english:'五',chinese:'今天'},
  ]
  ...
  let timeChoose=[
    ...
    return (
      <View className='read-appoint'>
        <View className='title'>选择预约时段</View>
