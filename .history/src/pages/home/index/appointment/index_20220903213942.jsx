    ...
    return (
      <View className='appointment'>
        <View className='totleView'>
          <Text style={{color:swiperCurrent==0?'#233941':''}} onClick={()=>setSwiperCurrent(0)}>功能阅读</Text>
          <Text style={{color:swiperCurrent==1?'#233941':''}} onClick={()=>setSwiperCurrent(1)}>特色内容</Text>
          <Text style={{color:swiperCurrent==2?'#233941':''}} onClick={()=>setSwiperCurrent(2)}>金牌讲师</Text>
        </View>
