    ...
    <View className='teacher-appoint'>
      <View className='teacher-info'>
        ...
        <View className='info-right'>
          <View className='info-name'>爱讲故事的阿伟</View>
          <View className='info-detail'>这是一段金牌讲师的客人介绍，有点东西这是一段金牌讲师的客人介绍，有点东西这是一段金牌讲师的客人介绍，有点东西</View>
        </View>
      </View>
