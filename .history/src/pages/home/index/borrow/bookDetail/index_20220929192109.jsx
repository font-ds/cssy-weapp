    ...
    return (
      <View className='book-detail font-default-style'>
        ...
        <AtActionSheet isOpened={borrowModal} className='book-time'>
          ...
          <View className='borrow-choose-time' style={{color:week==1?'white':'',backgroundColor:week==1?'#20C58D':''}} onClick={()=>setWeek(1)}>1周</View>
          <View className='borrow-choose-time' onClick={()=>setWeek(2)}>2周</View>
          <View className='borrow-choose-time' onClick={()=>setWeek(3)}>3周</View>
          <View className='borrow-choose-time' onClick={()=>setWeek(4)}>4周</View>
