...
export default function Index () {
  ...
  const getBooks = (name, type = 0) => {
    if (flag) {
      setFlag(false)
      let searchPage=type?page:0
      request({
        url: `/front/book?keyword=${name}&limit=10&page=${searchPage}`,
  ...
  useEffect(()=>{
    ...
    return (
      <View className='search-view'>
        ...
        <ScrollView scrollY enhanced showScrollbar={false} className='scroll-view' onScrollToLower={() => { 
