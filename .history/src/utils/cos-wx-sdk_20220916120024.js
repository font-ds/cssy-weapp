...
// 获取图片
export const getImage=async (key,index,dataList,func)=>{
    console.log(cos.getObjectUrl({
        ...
        let imageUrl= data.Url.replace('http','https').replace('httpss','https')
        dataList[index].imageUrl=imageUrl
        func([...dataList])
    }))
}
